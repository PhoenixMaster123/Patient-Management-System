...
public class LocalStack extends Stack {
    ...
    private DatabaseInstance createDatabase(String id, String dbName) {
        return DatabaseInstance.Builder
                ...
                .databaseName(dbName)
                .removalPolicy(RemovalPolicy.DESTROY) // destroy the database when the stack is deleted
                .build();
    }
    ...
    private CfnHealthCheck createDbHealthCheck(DatabaseInstance db, String id) {
        return CfnHealthCheck.Builder.create(this, id)
                .healthCheckConfig(CfnHealthCheck.HealthCheckConfigProperty.builder()
                        ...
                        .failureThreshold(3) // Allow 3 failures before declaring the db unhealthy
                        .build())
                .build();
    }
    ...
    private CfnCluster createMskCluster() {
        return CfnCluster.Builder.create(this, "MskCluster")
                ...
                .kafkaVersion("2.8.0")
                .numberOfBrokerNodes(1) // Control the number of broker nodes
    ...
    private Cluster createEcsCluster() {
        return Cluster.Builder.create(this, "PatientManagementCluster")
                .vpc(vpc)
                .defaultCloudMapNamespace(CloudMapNamespaceOptions.builder() // Create a default namespace for the cluster to use for service discovery in the VPC
    ...
    private void createApiGatewayService() {
        ...
        ContainerDefinitionOptions containerOptions = ContainerDefinitionOptions.builder()
                        .image(ContainerImage.fromRegistry("api-gateway")) // Use the image from the ECR repository for the service container
    ...
    public static void main(final String[] args) {
        ...
        // synthesizer converts Java code to CloudFormation template
        StackProps props = StackProps.builder()
                .synthesizer(new BootstraplessSynthesizer())
                .build();

        new LocalStack(app, "localstack", props);
        app.synth(); // synthesizes the stack to a CloudFormation template and stores it in the output directory
